...
-- Thời gian đã tạo: Th12 30, 2022 lúc 06:30 AM
...
CREATE TABLE `category` (
  ...
  `nameCategory` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `credit` (
  ...
  `number_card` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name_card` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cvc_card` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_card` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `order` (
  ...
  `random_order` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status_order` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(10, 1, 'V0fUUfub', 'Delivering', '2022-12-29 21:01:09', '2022-12-29 21:20:07');
...
CREATE TABLE `products` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `nameProducts` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `imgProducts` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `priceProducts` int(10) UNSIGNED NOT NULL,
  `descProducts` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `products_order` (
  ...
  `orders_random` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
